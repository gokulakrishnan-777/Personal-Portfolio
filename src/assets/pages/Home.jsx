                    ...
                    <div className="flex flex-1 flex-col items-center sm:items-start text-center sm:text-left w-full">
                        ...
                        <div className="border-t border-line w-full flex flex-col">
                            ...
                            <div className="h-auto sm:h-14 border-t border-line py-3 sm:py-2 flex flex-col sm:flex-row items-center sm:justify-between px-4 sm:pl-4 sm:pr-4 gap-3 sm:gap-0 w-full">
                                <div className="flex-1 min-h-10 sm:min-h-5 flex items-center justify-center sm:justify-start">
                                    <p
                                        key={phraseIndex}
                                ...
                                <div className="flex items-center gap-2 shrink-0">
                                    <button type="button" onClick={() => setIsResumeOpen(true)} className="inline-flex items-center gap-2 px-4 py-1.5 text-xs font-medium bg-foreground text-background border border-transparent rounded-lg hover:bg-foreground/90 transition-colors" aria-label="Open Resume Document">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" /><polyline points="10 9 9 9 8 9" /></svg>
                                        Resume
                                    </button>
                                    <a href="#contact" className="inline-flex items-center gap-2 px-4 py-1.5 text-xs font-medium border border-line rounded-lg hover:bg-accent-muted transition-colors text-foreground" aria-label="Contact Gokulakrishnan">
                                        Let's Talk
                                    </a>
                                </div>
                            </div>
                ...
                <section className="screen-line-top screen-line-bottom border-x border-line p-4 space-y-3">
                    <div className="grid gap-x-4 gap-y-3 sm:grid-cols-2">
                        ...
                        <div className="flex items-center gap-4 font-mono text-sm">
                            ...
                            <a href="mailto:agokul110@gmail.com" className="hover:text-foreground transition-colors text-muted-foreground">Email Gokulakrishnan</a>
                        </div>
                        <div className="flex items-center gap-4 font-mono text-sm">
                            ...
                            <a href="https://gokulakrishnana.vercel.app" target='_blank' rel="noopener noreferrer" className="hover:text-foreground transition-colors text-muted-foreground">Visit Portfolio Website</a>
                        </div>
                        <div className="flex items-center gap-4 font-mono text-sm sm:col-span-2">
                            ...
                            <a href="/Gokulakrishnan__A_Full stack developer.pdf" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors text-muted-foreground font-semibold" aria-label="Download Gokulakrishnan's Resume PDF">Download Resume</a>
                        </div>
                    </div>
                </section>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.3}>
                <section className="screen-line-top screen-line-bottom border-x border-line">
                    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3">
                        ...
                        <a href="https://www.linkedin.com/in/gokulakrishnan-a-g8608" target="_blank" rel="noopener noreferrer" className="flex cursor-pointer items-center gap-4 p-4 pr-2 transition-all duration-300 hover:bg-black/5 dark:hover:bg-black/40 hover:backdrop-blur-md border-b border-line md:border-r md:border-b-0" aria-label="Connect with Gokulakrishnan on LinkedIn">
                            ...
                            <h3 className="flex-1 font-medium text-sm">Connect on LinkedIn</h3>
                        </a>
                        <a href="https://x.com/GOKULAKRIS23058" target="_blank" rel="noopener noreferrer" className="flex cursor-pointer place-self-center md:place-self-auto  items-center gap-4 p-4 pr-2 transition-all duration-300 hover:bg-black/5 dark:hover:bg-black/40 hover:backdrop-blur-md col-span-2 md:col-span-1" aria-label="Follow Gokulakrishnan on X (Twitter)">
                            ...
                            <h3 className="flex-1 font-medium text-sm">Follow on X</h3>
                        </a>
                    </div>
                </section>
            </AnimatedSection>
