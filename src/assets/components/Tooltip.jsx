...
const Tooltip = ({ text, children, position = 'bottom', shortcut }) => {
    return (
        <div className="group/tooltip relative flex items-center  justify-center">
            ...
            <div className={`pointer-events-none absolute z-100 opacity-0 scale-95 group-hover/tooltip:opacity-100 group-hover/tooltip:scale-100 transition-all duration-200 origin-center
